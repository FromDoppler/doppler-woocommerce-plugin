...
class Doppler_For_Woocommerce
{
    ...
    {
        include_once DOPPLER_PLUGINS_PATH . 'doppler-form/includes/DopplerAPIClient/DopplerService.php';
    ...
    private function load_dependencies()
    {
         ...
         * side of the site.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'public/class-doppler-for-woocommerce-public.php';

        /**
         * The class responsible of managing the abandoned cart.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-doppler-for-woocommerce-ac.php';
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_dplrwoo_ajax_check_status', $plugin_admin, 'dplrwoo_check_status');
    ...
    private function define_public_hooks()
    {
        ...
        if (get_option('dplr_wc_open_graph_meta') == 1)
        {
